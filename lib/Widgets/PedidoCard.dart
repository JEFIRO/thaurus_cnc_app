...
import 'package:thaurus_cnc/service/PedidoService.dart';
import '../model/pedido/DetalhesPedidoPage.dart';
import '../model/pedido/PedidoModel.dart';
      ...
      child: InkWell(
        onTap: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  DetalhesPedidoPage(pedidoFuture: pedidoResponseFuture,),
            ),
          );
        },
        borderRadius: BorderRadius.circular(16),
