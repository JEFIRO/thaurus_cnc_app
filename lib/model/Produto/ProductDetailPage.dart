                ...
                children: [
                  ...
                  ...produto.variantes.map(
                    (v) => ExpansionTile(
                      ...
                      children: [
                        Text(
                          'Medidas do Produto: ${v.medida_produto.altura} x ${v.medida_produto.largura} x ${v.medida_produto.profundidade} cm, Peso: ${v.medida_produto.peso} kg',
                          style: TextStyle(color: AppTheme.cinzaClaro),
                        ),
                        const SizedBox(height: 4),
                        Text(
                          'Medidas da Embalagem: ${v.medida_embalagem.altura} x ${v.medida_embalagem.largura} x ${v.medida_embalagem.profundidade} cm, Peso: ${v.medida_embalagem.peso} kg',
                          style: TextStyle(color: AppTheme.cinzaClaro),
                        ),
                      ],
                    ),
