...
import '../model/Produto/Medida.dart';
import '../model/Produto/ProdutoModel.dart';
import '../model/Variante.dart';
...
class ProdutoForm extends StatefulWidget {
  ...
  const ProdutoForm({super.key, this.produtoModel, this.update = false});
    ...
    if (widget.produtoModel != null) {
      ...
      variantesForm = widget.produtoModel!.variantes.map((v) {
        return VarianteForm(
          ...
          medidaProduto: MedidaControllers.fromMedida(v.medida_produto),
          medidaEmbalagem: MedidaControllers.fromMedida(v.medida_embalagem),
        );
      }).toList();
    } else {
      personalizacoes = [
...
class MedidaControllers {
  ...
  static MedidaControllers fromMedida(Medida medida) {
